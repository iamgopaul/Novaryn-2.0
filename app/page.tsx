...
const features = [
  {
    ...
    description: 'Track your projects through the entire SDLC with visual pipelines, health indicators, and control tower views.'
  },
  {
    icon: Code2,
    title: 'Developer Tools',
    description: 'Built-in code editor, terminal, documentation generator, and snippet manager - everything you need in one place.'
  },
  {
    icon: Users,
    title: 'Team Collaboration',
    description: 'Invite team members, assign roles, and work together with shared history and real-time updates.'
  },
  {
    icon: MessageSquare,
    title: 'Community',
    description: 'Connect with other developers, share posts, follow friends, and build your professional network.'
  },
  {
    icon: Bot,
    title: 'AI Assistant',
    description: 'Get help with coding, debugging, and documentation using our powerful AI chatbot powered by Groq.'
  },
  {
    icon: Shield,
    title: 'Secure by Design',
    description: 'Two-factor authentication, secure sessions, and enterprise-grade security for your peace of mind.'
  }
]
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="mx-auto max-w-3xl">
            <h1 className="text-balance text-4xl font-bold tracking-tight md:text-6xl">
              Your All-in-One{' '}
              <span className="text-primary">Developer Hub</span>
            </h1>
            <p className="mx-auto mt-6 max-w-2xl text-pretty text-lg text-muted-foreground md:text-xl">
              Build, collaborate, and ship amazing software with powerful tools, 
              AI assistance, and a thriving developer community.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto mb-16 max-w-2xl text-center">
            ...
            <p className="mt-4 text-pretty text-muted-foreground">
              Novaryn combines powerful development tools, team collaboration, 
