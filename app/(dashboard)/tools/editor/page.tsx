...
import { Play, Copy, Download, Save, Code2 } from 'lucide-react'
...
export default function EditorPage() {
  ...
  const handleRun = () => {
    try {
      // Simple console.log capture for JS/TS
    ...
    <div className="flex h-[calc(100vh-10rem)] flex-col space-y-4">
      ...
      <div className="grid flex-1 gap-4 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            <pre className="min-h-[200px] rounded-lg bg-muted p-4 font-mono text-sm">
